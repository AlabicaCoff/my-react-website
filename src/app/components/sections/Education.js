    ...
    <section className="min-h-screen py-10 lg:py-16" id="education">
      <div className="min-h-screen text-4xl ">
        ...
        <div className="flex flex-col gap-16 mx-16 xl:mx-64">
          <div className="flex wrap flex-col-reverse lg:flex-row-reverse justify-center lg:justify-evenly rounded-2xl shadow-xl hover:shadow-2xl hover:-translate-y-1 overflow-hidden p-10 bg-[#37353E]">
            <div className="lg:w-3/5 px-2">
              ...
              <div className="ml-5">
                <p className="text-base indent-3 text-white">
                  • GPAX {education.pibul.gpax}
                </p>
                <p className="text-base indent-3 text-white">
                  • {education.pibul.duration}
                </p>
          ...
          <div className="flex wrap flex-col lg:flex-row justify-center lg:justify-evenly rounded-2xl shadow-xl hover:shadow-2xl hover:-translate-y-1 overflow-hidden p-2 md:p-10 bg-[#37353E]">
            <div className="lg:w-3/5 px-2">
              <h3 className="text-2xl font-semibold mb-5">
              ...
              <div className="ml-5">
                <p className="text-base indent-3 text-white">
                  • GPAX {education.kmitl.gpax}
                </p>
                <p className="text-base indent-3 text-white">
                  • {education.kmitl.duration}
                </p>
                <p className="text-base indent-5 mt-3 hidden md:block">
