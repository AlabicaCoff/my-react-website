    ...
    return (
        <section className="min-h-screen pt-24 lg:py-16">
          <div className="min-h-screen text-4xl mt-10 ">
            ...
            <div className="md:py-32 bg-gray-50 max-w-7xl mx-auto">
              <div className="px-4 sm:px-6 lg:px-8">
                <h3 className="text-2xl font-semibold mb-8">Frontend Development</h3>
              ...
              <div className="px-4 sm:px-6 lg:px-8 mt-10">
                <h3 className="text-2xl font-semibold mb-8">Database Development</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
